...
int main(int argc, char **argv)
{
  ...
  RobinSubscriber<TestStruct, robin_bridge::TestStruct> struct2_to_codesys(nh, "struct2_to_codesys");
  ...
  RobinPublisher<TestStruct, robin_bridge::TestStruct> struct2_to_ros(nh, "struct2_to_ros");
  ros::spin();
  return 0;
}
