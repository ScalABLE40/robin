...
* WIP
  * readme
    * explain fixed/variable length arrays
    * codesys installation
    * codesys usage: import example xml
    * ros installation and usage
    * installation: deps, codesys
...
* updater: support array of struct with strings/arrays
* debug
...
* detalhar TODOs
* review c++ 'structure padding': see [Code](#code)
