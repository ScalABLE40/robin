...
* WIP
  * fix idx == 1 instead of 0 for TestStruct
  * debug example project
  * fix for loop index variable name collisions
...
* review c++ 'structure padding': see [Code section](#code)
  * search '#pragma pack(1)' default behaviour
...
* fix 'cannot simlink from ...' warning when building
